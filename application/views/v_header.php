...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/css/stylemobil.css">
</head>
<body>
    <div id="wrapper">
        <header>
            <hgroup>
                <h1>Pustaka Booking</h1>
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="<?php echo base_url().'web/inuser'?>">User</a></li>
                </ul>
            </nav>
            <div class="clear"></div>
        </header>