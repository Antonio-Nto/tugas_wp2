    ...
    <div class="card border-left-primary shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          ...
          <div class="col-auto">
              <a href="<?= base_url('user/anggota');?>"><i class="fas fa-calendar fa-2x text-gray-300"></i></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card border-left-success shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          ...
          <div class="col-auto">
              <a href="<?= base_url('buku'); ?>"><i class="fas fa-dollar-sign fa-2x text-gray-300"></i></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card border-left-info shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          ...
          <div class="col-auto">
              <a href="<?= base_url('user'); ?>"><i class="fas fa-clipboard-list fa-2x text-gray-300"></i></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card border-left-warning shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          ...
          <div class="col-auto">
              <a href="<?= base_url('user'); ?>"><i class="fas fa-comments fa-2x text-gray-300"></i></a>
          </div>
        </div>
      </div>
    </div>
...
<div class="row">
 <div class="table-responsive table-bordered col-sm-5 ml-4 mrauto mt-2">
  <div class="page-header">
   <span class="fas fa-users text-primary mt-2 "> Data User</span>
    <a class="text-danger" href="<?= base_url('user/data_user'); ?>"><i class="fas fa-search mt-2 floatright"> Tampilkan</i></a>
  </div>
 ...
 <div class="table-responsive table-bordered col-sm-6 ml-auto mrauto mt-2">
  <div class="page-header">
